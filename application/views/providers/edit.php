                    ...
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo site_url("providers/update" ); ?>" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" name="provider[name]" value="<?php echo $provider->name; ?>" placeholder="Providers Name" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="provider[website]" value="<?php echo $provider->website; ?>" placeholder="Providers Website" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="input-group demo2">
                            <input type="text" name="provider[label]" value="<?php echo $provider->label; ?>" class="form-control" />
